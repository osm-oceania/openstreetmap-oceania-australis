...
- Emergency
  ...
  - Emphasis on rural fire support \- emergency=water_tank, water=reservoir, fire trails (but no specific tagging for these from what I can see)
...
- Colours
  ...
  - Colour-blind style/mode (increased usage of symbols and patterns to distinguish lines/ways/features) **_This should be default_**
